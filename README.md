...
- **Communal leaderboard** — home standings and challenges aggregate every user's rounds; profile, stats, and rounds pages show your own data.
- **Read-only enforcement** — write operations (save round, edit course, change settings) are restricted to your own data.

## Stats & Data Model

PinSheet records five per-hole stats per round — score, fairway, GIR, putts, penalties — then computes a WHS handicap index and 50+ derived stats. See **[docs/STATS.md](docs/STATS.md)** for the full data model and stats reference.

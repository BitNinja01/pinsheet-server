...
@require_permission(scopes.ROUNDS_READ, contract="problem")
...
@require_permission(scopes.ROUNDS_WRITE, contract="problem")
@require_json_body
...
@require_permission(scopes.ROUNDS_DELETE, contract="problem")

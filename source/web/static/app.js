// Delegated confirm() gate for forms marked data-confirm="...".
// Replaces the former inline onsubmit= handler so the page needs no
// inline-script allowance in the Content-Security-Policy.
